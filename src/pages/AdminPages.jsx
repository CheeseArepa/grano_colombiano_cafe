...
export function ClientesAdminPage() { const c = useOutletContext(); return <GestionClientes clientes={c.clientes} cargando={c.cargandoClientes} />; }
export function OrdenesAdminPage() { const c = useOutletContext(); return <GestionOrdenes ordenes={c.ordenes} cargando={c.cargandoOrdenes} />; }
