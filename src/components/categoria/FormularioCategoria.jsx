  ...
  useEffect(() => {
    if (categoriaAEditar) {
      setFormData({
        ...
        estado: Boolean(categoriaAEditar.estado)
      });
    } else {
    ...
    <div className="card-form-container">
      <div className="form-header">
        ...
        <p className="form-subtitle">
          {esEdicion ? 'Modifica los datos de la categoría seleccionada' : 'Ingresa los datos para agregar una categoría al catálogo'}
        </p>
      </div>
